...
//Método editar Evento
	...
	public String updateEvento(Eventos evento) {
		...
		Eventos eventoExist = eveS.getListEventosId(evento.getId());
		eventoExist.setNombre(eventoExist.getNombre());
		eventoExist.setFecha(eventoExist.getFecha());
		eventoExist.setHora(eventoExist.getHora());
		eventoExist.setSedes(eventoExist.getSedes());
		
		eveS.guardarEventos(eventoExist);
